...
export const OfficeWearProductListSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-start gap-[9px] w-full max-w-[1381px] mx-auto px-[30px] mt-[104px]">
      ...
      <div className="flex flex-col items-start gap-[30px] w-full">
        <div className="grid grid-cols-3 gap-5 w-full">
          {products.slice(0, 3).map((product) => (
            ...
            >
              <div
                className="relative w-full h-[669px] bg-cover bg-center bg-no-repeat"
              ...
              <CardContent className="flex flex-col items-start w-full p-0">
                <div className="flex flex-col items-start pl-2 pr-0 py-2 w-full">
